...
# 1. Start with a list of two jackalopes at age 0
# 2. Start year count at 0
# 3. while len(listalopes) < 1000
# 4. add 1 to each jackalope's age
# 5. count how many are in the breeding range, round down to nearest even number
# 6. add that number of new jackalopes
# 7. kill the 10 year olds
# 8. increment year


listalopes = [1, 2, 3, 10, 4, 10, 10, 5, 11]
...
# listalopes = [v for v in listalopes if v < 10]
...
# while 10 in listalopes:
#     listalopes.remove(10)
