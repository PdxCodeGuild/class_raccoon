...
print("I'm thinking of another number between 1 and 10.\nThis time I'll tell you if you're too high or too low: ")
(pick_num, comp_num) = user_input()
...
pick_num = 0
while pick_num not in range_num:
    pick_num = input("My turn! Pick a number between 1 and 10 and I will try to guess it.\nI promise I won't peek: ")
    pick_num = int(pick_num)
